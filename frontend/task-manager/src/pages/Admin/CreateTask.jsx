...
const CreateTask = () => {
  ...
  const createTask = async () => {
    ...
    try {
      ...
      toast.success("Task Created Scuccessfully");
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 mt-4'>
        <div className='form-card col-span-3'>
          ...
          <div className='flex justify-end mt-7'>
            <button
            className='add-btn w-full items-center justify-center gap-1.5 text-xs md:text-sm font-medium text-blue-500 whitespace-nowrap bg-blue-50 border border-blue-100 rounded-lg px-4 py-2 cursor-pointer'
